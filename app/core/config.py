...
TOOLS = [
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "Вызывай, когда из диалога появляется устойчивый факт о пользователе или о Еве (о тебе)."
            ),
            "parameters": {
                "type": "object",
                "properties": {
                    "owner": {
                        ...
                        "description": (
                            ...
                            "или 'Eva' для фактов о самой Еве (о тебе)."
                        )
                    },
                    "scope": {
                        "type": "string",
                    ...
                    "key": {
                        "type": "string",
                        "description": "Краткое имя факта. Например: 'любимая игра', 'стиль общения'."
                    },
                    "value": {
                        "type": "string",
                        "description": "Текстовое значение факта."
                    },
                    "importance": {
                        "type": "number",
                        "description": (
